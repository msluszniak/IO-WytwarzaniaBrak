...
class GymCard extends StatelessWidget {
  ...
  const GymCard({Key? key, required this.selectedGym, required this.tags}) : super(key: key);
...
class GymCardDraggable extends StatelessWidget {
  ...
  const GymCardDraggable({Key? key, required this.selectedGym}) : super(key: key);
